...
class ChordInstance(object):
    ...
    def update_others(self):
        ...
        for i in range(0,m):
            ...
            #print('predecessor of {0} is {1}'.format(val, n.ID))
            print('Update finger table of Node {0}'.format(val))
            if (n != None):
                n.update_finger_table(self, i)
...
if __name__ == '__main__':
    ...
    chord2 = ChordInstance('127.0.0.1', 9001, 2)
    chord3 = ChordInstance('192.168.1.1', 9002, 5)
