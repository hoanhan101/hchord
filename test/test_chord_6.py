...
if __name__ == '__main__':
    chord1 = ChordInstance('0.0.0.0', 9000, 5)
    ...
    # print(chord1.find_successor(2).ID)
    # print(chord1.find_successor(3).ID)
    # print(chord1.find_successor(5).ID)
